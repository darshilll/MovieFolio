...
const Navbar = ({ setSearchResults }) => {
  ...
  return (
    <>
      ...
      <form onSubmit={handleSearch} className="md:flex items-center hidden md:block">
        <input
          type="text"
          value={query}
      ...
      <form onSubmit={handleSearch} className="flex items-center justify-center mt-2 md:hidden">
        <input
          type="text"
          value={query}
          onChange={(e) => setQuery(e.target.value)}
